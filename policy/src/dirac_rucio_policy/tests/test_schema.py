...
valid_lfns = [
    "/testvo/foo/bar/test.dat",
    "/testvo/foo/bar/1234.dat",
    "/foo/bar",
    "/foo/bar/test.dat",
    "/testvo/dl0/telescope/TEL001/events/2024/06/17/TEL001_SDH001_20240617T030105_SBID2000012345_OBSID2000006789_TEL_SHOWER_CHUNK000.fits.fz",
]
...
def test_scope_name_regexp():
    ...
    true_scope = "foo"
    lfn = f"/testvo/{true_scope}/bar/test.dat"
